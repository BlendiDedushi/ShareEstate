  ...
  return (
    <div>
      ...
      <div className="container">
        <div className={`${styles.formGroup} mt-8 mx-6`}>
          <div className="flex gap-8">
            <div className="flex flex-col justify-center">
              <label htmlFor="type" className="mb-2 text-lg">
                Select a property type:
              </label>
              <select
                id="type"
                className={`px-4 py-2 border border-gray-300 rounded-lg focus:outline-none w-72 ${styles.inputField}`}
                value={type}
            ...
            <div className="flex flex-col justify-center">
              <label htmlFor="price" className="mb-2 text-lg">
                Select a price:
              </label>
              <select
                id="price"
            ...
            <div className="flex flex-col justify-center">
              <label htmlFor="search" className="mb-2 text-lg">
                Search:
              </label>
              <input
                type="search"
